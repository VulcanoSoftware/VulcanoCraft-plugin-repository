...
class AdminPage {
    ...
    _renderPaginationControls(container, currentPage, totalPages, onPageClick) {
        ...
        html += `<li class="page-item ${prevDisabled}"><button class="page-link" data-page="${currentPage - 1}" aria-label="${i18n.t('pagination.previous')}">&laquo;</button></li>`;
        ...
        html += `<li class="page-item ${nextDisabled}"><button class="page-link" data-page="${currentPage + 1}" aria-label="${i18n.t('pagination.next')}">&raquo;</button></li>`;
